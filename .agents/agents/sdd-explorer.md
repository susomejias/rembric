...
3. **What is the actual blast radius?** One Node process, one SQLite file, and a plugin tree shipping to FIVE clients (Claude Code, Codex CLI, Hermes, opencode, Pi) — a change that looks local often is not.
