...
// Co-located with the module it reads: `save-time-candidates.ts` is a sibling.
const DOMAIN_SAVE_TIME_CANDIDATES = new URL('./save-time-candidates.ts', import.meta.url);
