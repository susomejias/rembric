// Duplicated from apps/server/src/test/default-project.ts (see also
// packages/db/src/test-support/default-project.ts and packages/core/src/test-support/default-project.ts).
