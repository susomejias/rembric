// eslint-disable-next-line @typescript-eslint/triple-slash-reference -- the ambient shim must join every program that compiles this package from source
/// <reference path="./stopword.d.ts" />
