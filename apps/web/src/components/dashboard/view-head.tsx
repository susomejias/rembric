...
/**
 * The view header shared by every ported dashboard page: the numbered eyebrow,
 * the page title and the right-aligned meta chips. The React replacement for
 * `apps/server/src/dashboard/components.ts::viewHead`.
 *
  ...
  return (
    <header className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div className="flex flex-col gap-1">
        <p className="font-mono text-xs tracking-[0.18em] text-brand-accent uppercase">§ {num}</p>
