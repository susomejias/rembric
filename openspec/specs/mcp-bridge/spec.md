...
Defines the published zero-dependency client-side Rembric MCP bridge, including its stdio transport, project resolution, recovery, and package-distribution contract.
